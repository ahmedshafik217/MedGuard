...
def create_app(config_class=Config):
    ...
    def inject_auth_state():
        from app.utils import current_owner, current_owner_permissions, current_patient
        owner = current_owner()
        patient = current_patient()
        # Permission booleans for the logged-in owner-side account (see
        # app/roles.py) -- injected globally so every owner/* template can
