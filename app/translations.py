...
STRINGS = {
    ...
    "speak_antibiotic_name": {"en": "Speak the antibiotic name", "ar": "قل اسم المضاد الحيوي"},
    "voice_listening": {"en": "Listening… speak the antibiotic name now", "ar": "جاري الاستماع... قل اسم المضاد الحيوي الآن"},
    ...
    "voice_error": {"en": "Couldn't hear that — please try again or type it.", "ar": "لم أستطع سماع ذلك - حاول مرة أخرى أو اكتبه."},
    "voice_not_supported": {"en": "Voice input isn't supported in this browser — please type instead.", "ar": "الإدخال الصوتي غير مدعوم في هذا المتصفح - يرجى الكتابة بدلاً من ذلك."},
